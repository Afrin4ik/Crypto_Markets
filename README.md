...
Веб-сервис для мониторинга цены Bitcoin в режиме реального времени и получения прогноза направления движения цены на ближайший промежуток времени с помощью алгоритма Permutation Decision Tree.

Проект разработан как продуктовая часть курсовой работы на тему «Разработка и исследование алгоритмов для прогнозирования финансовых рынков на основе адаптации современных научных методов. Алгоритм для прогнозирования цены Bitcoin на основе Permutation Decision Trees».
